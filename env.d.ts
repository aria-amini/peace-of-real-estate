...
type _CoercedEnvSchema_be81a996 = CoercedEnvSchema

declare module 'varlock/env' {
	export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_be81a996> {}
	export interface PublicTypedEnvSchema extends Readonly<
		Pick<
			_CoercedEnvSchema_be81a996,
			| 'APP_ENV'
			| 'VITE_PUBLIC_POSTHOG_KEY'
			| 'BETTER_AUTH_URL'
			| 'GOOGLE_CLIENT_ID'
...
type _EnvSchemaAsStrings_be81a996 = EnvSchemaAsStrings
declare global {
	// add types for global import.meta.env
	interface ImportMetaEnv extends _EnvSchemaAsStrings_be81a996 {}
	...
	namespace NodeJS {
		interface ProcessEnv extends _EnvSchemaAsStrings_be81a996 {}
	}
}
