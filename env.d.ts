...
type _CoercedEnvSchema_865255ca = CoercedEnvSchema;

declare module 'varlock/env' {
  export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_865255ca> {}
  export interface PublicTypedEnvSchema extends Readonly<Pick<_CoercedEnvSchema_865255ca, 'APP_ENV' | 'RAILWAY_ENVIRONMENT_NAME' | 'VITE_PUBLIC_POSTHOG_KEY' | 'BETTER_AUTH_URL' | 'GOOGLE_CLIENT_ID' | 'AVATAR_BUCKET' | 'VIDEO_BUCKET' | 'AWS_REGION' | 'AWS_ENDPOINT_URL' | 'AI_BASE_URL' | 'AI_MODEL'>> {}
}
...
type _EnvSchemaAsStrings_865255ca = EnvSchemaAsStrings;
declare global {

  // add types for global import.meta.env
  interface ImportMetaEnv extends _EnvSchemaAsStrings_865255ca {}
  ...
  namespace NodeJS {
    interface ProcessEnv extends _EnvSchemaAsStrings_865255ca {}
  }
}