...
type _CoercedEnvSchema_b4d61d70 = CoercedEnvSchema

declare module 'varlock/env' {
	export interface TypedEnvSchema extends Readonly<_CoercedEnvSchema_b4d61d70> {}
	export interface PublicTypedEnvSchema extends Readonly<
		Pick<
			_CoercedEnvSchema_b4d61d70,
			| 'APP_ENV'
			| 'RAILWAY_ENVIRONMENT_NAME'
			| 'VITE_PUBLIC_POSTHOG_KEY'
			| 'BETTER_AUTH_URL'
...
type _EnvSchemaAsStrings_b4d61d70 = EnvSchemaAsStrings
declare global {
	// add types for global import.meta.env
	interface ImportMetaEnv extends _EnvSchemaAsStrings_b4d61d70 {}
	...
	namespace NodeJS {
		interface ProcessEnv extends _EnvSchemaAsStrings_b4d61d70 {}
	}
}
