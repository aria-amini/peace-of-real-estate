...
test('consumer practice negotiating page matches desktop screenshot', async () => {
	await expectRouteScreenshot({
		path: '/consumer/dashboard/practice-negotiating',
		name: 'consumer-practice-negotiating',
	})
})
